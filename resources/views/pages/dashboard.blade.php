...
@section('content')
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card card-dash p-3 d-flex flex-column justify-content-center" style="overflow: hidden;">
                <p class="mb-2 text-center fw-semibold">Taxa de Aprovação ({{ $text }})</p>
