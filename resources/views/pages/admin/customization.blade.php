        ...
        <section class="customization-section">
            ...
            <div class="customization-image-block">
                <div class="customization-image-main">
                    <x-image-upload id="logo_light" name="logo_light" label="Logo modo claro (1080×174)" :value="$settings->logo_light" />
                </div>
                <div class="customization-restore-form">
                    <button type="button" class="btn-restore js-restore-default" data-restore="logo_light" data-confirm="Usar logo padrão do sistema?"><i class="fa-solid fa-rotate-left"></i> Restaurar padrão</button>
                </div>
            </div>

            <div class="customization-image-block">
                <div class="customization-image-main">
                    <x-image-upload id="logo_dark" name="logo_dark" label="Logo modo escuro (1080×174)" :value="$settings->logo_dark ?? null" />
                </div>
                <div class="customization-restore-form">
                    <button type="button" class="btn-restore js-restore-default" data-restore="logo_dark" data-confirm="Remover logo do modo escuro?"><i class="fa-solid fa-rotate-left"></i> Restaurar padrão</button>
                </div>
            </div>
            ...
            <div class="customization-image-block">
                ...
                <div class="customization-restore-form">
                    <button type="button" class="btn-restore js-restore-default" data-restore="favicon_light" data-confirm="Usar ícone padrão do sistema?"><i class="fa-solid fa-rotate-left"></i> Restaurar padrão</button>
                </div>
            </div>
            ...
            <div class="customization-image-block customization-image-block--full">
                ...
                <div class="customization-restore-form">
                    <button type="button" class="btn-restore js-restore-default" data-restore="login_background" data-confirm="Usar background padrão do sistema?"><i class="fa-solid fa-rotate-left"></i> Restaurar padrão</button>
                </div>
                @endif
            </div>
        </section>
...
document.querySelectorAll('.js-restore-default').forEach(function(btn) {
    btn.addEventListener('click', function() {
        var restore = this.getAttribute('data-restore');
        var msg = this.getAttribute('data-confirm') || 'Restaurar padrão?';
