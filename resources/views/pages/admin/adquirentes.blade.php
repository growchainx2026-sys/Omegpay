...
@section('content')
    ...
    <form class="row" method="POST" action="{{ route('admin.adquirentes.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control" id="adquirencia_pix" name="adquirencia_pix">
                                    ...
                                    <option value="transfeera" {{ $adquirenciaPix == 'transfeera' ? 'selected' : '' }}>
                                        ...
                                        Pagar.me</option>
                                        <option value="xgate" {{ $adquirenciaPix == 'xgate' ? 'selected' : '' }}>
                                        XGate</option>
                                        <option value="getpay" {{ $adquirenciaPix == 'getpay' ? 'selected' : '' }}>
                                        GetPay</option>
                                        <option value="getpay2" {{ $adquirenciaPix == 'getpay2' ? 'selected' : '' }}>
                                        GetPay2</option>
                                        <option value="rapdyn" {{ $adquirenciaPix == 'rapdyn' ? 'selected' : '' }}>
                                        Rapdyn</option>
                                </select>
        ...
        <div class="col-12 col-md-3">
            <x-card-adquirente :title="'XGATE'" :name="'xgate'" :id="'xgate'" :image="asset('assets/images/gate-white.png')"
                :background="'black'" :data="$xgate">
            </x-card-adquirente>
        </div>
        <div class="col-12 col-md-3">
            <x-card-adquirente :title="'GETPAY'" :name="'getpay'" :id="'getpay'" :image="asset('assets/images/getpay.png')"
                :background="'black'" :data="$getpay">
            </x-card-adquirente>
        </div>
        <div class="col-12 col-md-3">
            <x-card-adquirente :title="'GETPAY2'" :name="'getpay2'" :id="'getpay2'" :image="asset('assets/images/getpay.png')"
                :background="'black'" :data="$getpay2">
            </x-card-adquirente>
        </div>
        <div class="col-12 col-md-3">
            <x-card-adquirente :title="'RAPDYN'" :name="'rapdyn'" :id="'rapdyn'" :image="asset('assets/images/rapdyn.png')" :background="'black'" :data="$rapdyn">
            </x-card-adquirente>
        </div>
    </form>
