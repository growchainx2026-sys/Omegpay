...
<head>
    <meta charset="UTF-8">
    <title>{{ $setting->software_name }} - Nova senha area de membros</title>
</head>
                ...
                <tr>
                    <td align="left">
                        <p
                            ...
                            <br><br>Segue abaixo a nova senha de acesso para sua área de membro. <strong>
                    </td>
                </tr>
                <tr>
                    <td align="left">
                        <p
                            ...
                            Seu email: {{ $aluno->email }} <br>
                            Sua nova senha: {{ $newpassword }} <br>
                            Acesse: <a href="{{ env('APP_URL') }}/login?form=aluno">Área de membros</a><br>
                        </p>
                    </td>
                </tr>
                {{-- <tr>
