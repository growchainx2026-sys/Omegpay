<div class="nav-alert">
    ...
    @endif
    <div class="dropstart nav-icon-btn-wrapper">
        <i data-lucide="bell" class="nav-action-icon cursor-pointer" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="width: 20px; height: 20px;"></i>
