...
<head>
    <meta charset="UTF-8">
    <title>{{ $setting->software_name }} - Nova senha de produtor</title>
</head>
                ...
                <tr>
                    <td align="left">
                        <p
                            ...
                            <span style="font-weight:bold;font-size:32px">Olá, {{ $user->name }}!</span>
                            <br><br>Segue abaixo a nova senha de acesso para {{ $setting->software_name }}. <strong>
                    </td>
                </tr>
                <tr>
                    <td align="left">
                        <p
                            ...
                            Sua nova senha: {{ $newpassword }} <br>
                            Acesse: <a href="{{ env('APP_URL') }}/login?form=produtor">Área de produtor</a><br>
                        </p>
                    </td>
                </tr>
                {{-- <tr>
