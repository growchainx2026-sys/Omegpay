...
use App\Traits\{CashtimeTrait, SixxpaymentsTrait, EfiTrait, WitetecTrait, GetpayTrait, Getpay2Trait, XGateTrait, RapdynTrait};
...
{
    use CashtimeTrait, SixxpaymentsTrait, EfiTrait, WitetecTrait, GetpayTrait, Getpay2Trait, XGateTrait, RapdynTrait;
    /**
    ...
    Helper::calculaSaldoLiquido($request->user->user_id);
        ...
        switch ($adquirencia) {
            ...
            case 'witetec':
                ...
                break;
            case 'getpay':
                $response = self::requestPaymentGetpay($request);
                break;
            case 'getpay2':
                $response = self::requestPaymentGetpay2($request);
                break;
            case 'xgate':
                $response = self::requestPaymentXgate($request);
                break;
            case 'rapdyn':
                $response = self::requestPaymentRapdyn($request);
                break;
            default:
