...
use App\Traits\{CashtimeTrait, SixxpaymentsTrait, EfiTrait, AppmaxTrait, WitetecTrait, PagarmeTrait, GetpayTrait, Getpay2Trait, XGateTrait, RapdynTrait};
use App\Models\User;
...
class DepositController extends Controller
{
    ...
    PagarmeTrait, GetpayTrait, Getpay2Trait,
    XGateTrait, RapdynTrait;
    /**
    ...
    public static function deposit(Request $request)
    {
        ...
        switch ($adquirencia) {
            ...
            case 'pagarme':
                ...
                break;
            case 'getpay':
                $response = self::requestDepositGetpay($request);
                break;
            case 'getpay2':
                $response = self::requestDepositGetpay2($request);
                break;
            case 'xgate':
                $response = self::requestDepositXgate($request);
                break;
            case 'rapdyn':
                $response = self::requestDepositRapdyn($request);
                break;
            default:
