...
use App\Traits\{CashtimeTrait, SixxpaymentsTrait, EfiTrait, WitetecTrait, PagarmeTrait, GetpayTrait, Getpay2Trait, XGateTrait, RapdynTrait};
...
class TransactionsController extends Controller
{
    ...
    public function depositoWeb(Request $request)
    {
        ...
        switch ($adquirencia) {
            ...
            case 'pagarme':
                ...
                break;
            case 'getpay':
                $response = GetpayTrait::requestDepositGetpay($newrequest);
                break;
            case 'getpay2':
                $response = Getpay2Trait::requestDepositGetpay2($newrequest);
                break;
            case 'xgate':
                $response = XGateTrait::requestDepositXgate($newrequest);
                break;
            case 'rapdyn':
                $response = RapdynTrait::requestDepositRapdyn($newrequest);
                break;
            default:
    ...
    public function saquePix(Request $request)
    {
        ...
        $adquirencia = $setting->adquirencia_pix ?? $setting->adquirencia;
        switch ($adquirencia) {
            case 'cashtime':
            ...
            case 'pagarme':
                ...
                break;
            case 'getpay':
                $response = GetpayTrait::requestPaymentGetpay($newrequest);
                break;
            case 'getpay2':
                $response = Getpay2Trait::requestPaymentGetpay2($newrequest);
                break;
            case 'xgate':
                $response = XGateTrait::requestPaymentXgate($newrequest);
                break;
            case 'rapdyn':
                $response = RapdynTrait::requestPaymentRapdyn($newrequest);
                break;
            default:
                $response = ['data' => ['status' => 'error', 'message' => 'Erro inesperado'], 'status' => 500];
                break;
