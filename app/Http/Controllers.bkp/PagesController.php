...
class PagesController extends Controller
{
    ...
    {
        //dd($request->all());
        auth()->user()->software_color = $request->input('software_color') ?? auth()->user()->software_color;
        auth()->user()->software_color_background = $request->input('software_color_background') ?? auth()->user()->software_color_background;
        auth()->user()->software_color_sidebar = $request->input('software_color_sidebar') ?? auth()->user()->software_color_sidebar;
        auth()->user()->software_color_text = $request->input('software_color_text') ?? auth()->user()->software_color_text;
